...
function generatePassword() {
  ...
  generatedPassword = passwordDisplay.textContent = charctersArray.join("");
...
function showCopyMessage() {
  ...
  passwordCopiedMessage.setAttribute("aria-hidden", "false");
}
function hideCopyMessage() {
  passwordCopiedMessage.classList.add("hidden");
  passwordCopiedMessage.setAttribute("aria-hidden", "true");
}

function handleCopy(generatedPassword) {
